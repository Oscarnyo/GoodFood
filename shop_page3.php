...
<div class="w3-row-padding w3-padding-64 w3-container">
  ...
  <div class="w3-center w3-padding-32">
    ...
    <div class="w3-bar">
      ...
      <a href="shop_page1.php" id="page1" onClick="page1Function()" class="w3-bar-item w3-hover-black w3-button page-button">1</a>
      <a href="shop_page2.php" id="page2" onClick="page2Function()" class="w3-bar-item w3-button w3-hover-black page-button">2</a>
      <a href="shop_page3.php" id="page3" onClick="page3Function()" class="w3-bar-item w3-button w3-black page-button">3</a>
      <a href="#" class="w3-bar-item w3-button w3-hover-black">»</a>
    </div>
  </div>
