...
<!-- Navbar -->
<?php include('../asg2/Oscar_external_file/view/navbar_login.php') ?>
                  ...
                  if($result = mysqli_query($link, $sql)){
                    if(mysqli_num_rows($result) > 0){
                      while($row = mysqli_fetch_array($result)){
                        ...
                        echo "<a href="."sub_con_login.php?sub_id=" . $row['subscription_id'] . "><button id='sub_btn'>Subscribe now</button></a>";
                      }
