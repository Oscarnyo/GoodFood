...
<div class="w3-row-padding w3-padding-64 w3-container">
  <div class="w3-content">
     <div class="w3-third w3-center"><!--Product picture-->
      <img class="w3-padding-right w3-margin-right" src="./SJ_external_file/picture/ticket.png">
    </div>
                                ...
                                if($result = mysqli_query($link, $sql)){
                                    if(mysqli_num_rows($result) > 0){
                                         while($row = mysqli_fetch_array($result)){
                                            ...
                                            echo  "<h5 class='w3-padding-top'>Description : ".$row['description']."<b> (Note that only registered user able to participate Lucky Draw in prize tab)</b></h5>"; 
  ...
  <div class="w3-center w3-padding-32">
    ...
    <div class="w3-bar">
      ...
      <a href="shop_page2_login.php" id="page2" onClick="page2Function()" class="w3-bar-item w3-button w3-hover-black page-button">2</a>
      <a href="shop_page3_login.php" id="page3" onClick="page3Function()" class="w3-bar-item w3-button w3-black page-button">3</a>
      <a href="#" class="w3-bar-item w3-button w3-hover-black">»</a>
    </div>
  </div>
